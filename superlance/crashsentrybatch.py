...
#
# [eventlistener:crashsentrybatch]
# command=python crashsentrybatch --sentryDsn=http://sentrydns.com/myapi
# events=PROCESS_STATE,TICK_60

doc = """\
crashsentrybatch.py [--interval=<batch interval in minutes>]
...
A sample invocation:
    ...
    crashsentrybatch.py --sentryDsn="http://sentrydsn.com/123"
...
class CrashSentryBatch(ProcessStateSentryMonitor):
...
def main():
    crash = CrashSentryBatch.create_from_cmd_line()
    crash.run()
